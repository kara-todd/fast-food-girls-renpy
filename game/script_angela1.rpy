...
label angela_1:
  ...
  ang @ happy "[locPizza]. Here’s your order."
  ...
  ang @ happy "Look dude, talk is cheap and so is this pizza.{w=.5} You can call corporate and whine over your $10 if you want.{w=.25} I don’t care."
  ang @ happy "For me, the only question is are you going to take this pizza or am I?"
  ...
  ang @ sad "He wouldn’t take the pizza. He-"
  ...
  phone "*click*"
  ang @ wtf "Are you serious right now? What was that?!?"
  ...
  ang @ angry "...."
  ang @ angry "Yeah. Well, I hope you enjoy your free pizza"
  mc "Two now."
  ang @ angry "Free Pizzas…"
  mc "Well, technically, one free pizza and a free future meal of my choice. :)"
  ang @ angry "Or whatever…"
  ang @ angry "I guess now at least I can be over this dumb job."
  mc "Oh… surely you won't lose your job over one little upset customer."
  "(Her death stare slides into a sidelong grimace.)"
  ang @ sad "Maybe not one customer no."
  ...
  ang @ angry "You don’t know me… and I don’t owe you anything. So I’m out of here. Later jerkwad."
  ...
  ang @ angry "There !@#$#! Hot and right on to ya!"
...
label angela_2:
  ...
  ang @ wtf "SERIOUSLY!?{w=.75} Erk-{w=.5} *whispers* seriously dude?!{w=.25} Are you calling again?"
  ...
  ang @ angry "No man, I won’t… and you want to know why? Because I’m suspended from delivery duty due to a “customer complaint” issue."
  ang @ sad "So there go my cash tips"
  mc "No! That can't be right. I for one think you are an exemplary employee."
  ang @ wtf "…"
  ang @ wtf "…"
  ang @ angry "You’re kidding right?"
  ...
  ang @ angry "…"
  ang @ angry "Yeah.{w=.5} Sure man.{w=.5} Whatever."
  mc "Not that I'll be complaining about it if it means more free service."
  ang @ angry "Cool.{w=.5} Great.{w=.5} Thanks for the pep talk.{w=.5} Are you actually going to order something?"
  ...
  show vanessa zorder 4 at center
  show angela zorder 1 at left

  $ van.name = "???"

  van @ happy "Thic Pies. We have an extra large order here."
  van @ happy "Uh… you did order 150 pizzas… right?"
  mc "I most certainly did."
  ang @ angry "..."
  van @ happy "Great! Well, we can star t getting them from the cars-"
  ang @ angry "Sure is a lot pizzas for one dude."
  "(The delivery girls cuts an angry glance at Angela)"
  van @ happy "Haha. I mean… It is the biggest order I've seen."
  mc "It would be. However, it's not all for me. I have a party out back."
  van @ happy "Oh. Well that makes sense-"
  ang @ angry "You do not need this many pizzas dude."
  van @ angry "*whispers* oh my god. Angela! What is wrong with you. Don't harass the customer."
  van @ happy "haha. It does maybe seem like a bit much though?"
  mc "Oh? I wanted to be sure I was prepared."
  mc "And what would your recommendation be miss… Angela? Was it?"
  ang @ wtf "I don't know man. If you want hella pizzas that's your business I guess."
  ang @ angry "The only thing I need to know is where to put them."
  van @ happy "Y-Yeah. You want these inside I guess? We normally just hand them off at the door, but I'm not sure that will quite work. Haha?"
  ...
  van @ happy "I'll grab some more boxes Angela!"
  "(She runs back around the house.)"
  hide vanessa with dissolve
  show angela at center with dissolve
  ang @ wtf "What's your deal man? Are you messing with me or something?"
  mc "I'd say that's kind of presumptions isn't it?"
  ang @ angry "Yeah. I don't know. You call me. Then we get this weird order."
  ...
  ang @ sad "…"
  ang @ sad "It's still weird man. Who orders that many pizzas?"
  ...
  ang @ wtf "Manager? Like your boss or something?"
  ...
  ang @ angry "Oh. So you're loaded."
  mc "(I can't help but grin) Maybe. That would depend on your definition."
  ang @ angry "Yeah. I don't think that matters in this case dude."
  van @ angry "Angela! Are you getting more pizzas! Where are you?"
  ang @ angry "I'm coming man! Chill! I have questions about the order!"
  mc "Sounds like you've got work."
  ang @ angry "Yeah."
  mc "Well. If you've got some free time after maybe you should drop by the party tonight."
  ang @ wtf "Why would I crash your weird work thing?"
  ...
  ang @ sad "Maybe. I'll think about it."
  ang @ sad "I got stuff to do and all. So I don't know if I'll have time."
  "(The other pizza girl comes back around the house arms full of pizza boxes.)"
  van @ angry "Angela!!!"
  ang @ angry "Dude!! Lay off!"
  ...
  van @ happy "Uh… really? Well, Ok. I do need her help though. We have so many boxes."
  ...
  ang @ angry "Uh. I don't really have-"
